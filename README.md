...
**Angular practice project for learning modern development: budget tracker with
hierarchical categories, transaction forms, charts, authentication, async
patterns, LocalStorage database.**
